...
以上为当前 3D 打印外壳的工程样机实拍，不代表已经锁定的量产外观、颜色或装配公差。
...
- 当前硬件资料属于工程样机。2026-08-30 的 ECAD 工程与 2026-08 的机械 STEP 尚未完成板框、接口和装配公差对齐，不能直接作为生产或开模依据；详见 [制造归档检查](docs/MANUFACTURING_STATUS.md)。
